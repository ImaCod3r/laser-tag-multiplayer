export class AudioManager {
    constructor() {
        ...
        // PowerUps sounds
        this.invisibilitySound = new Audio('/assets/sounds/invisibility_sfx.mp3');
        this.speedSound = new Audio('/assets/sounds/speed_sfx.mp3');
        this.shieldSound = new Audio('/assets/sounds/shield_sfx.mp3');
        ...
        this.invisibilitySound.volume = 0.6;
    ...
    playInvisibilitySound() {
        this.invisibilitySound.currentTime = 0;
        this.invisibilitySound.play().catch(e => console.log("Could not play collecting sound:", e));
    }

    playSpeedSound() {
        this.speedSound.currentTime = 0;
        this.speedSound.play().catch(e => console.log("Could not play collecting sound:", e));
    }

    playShieldSound() {
        this.shieldSound.currentTime = 0;
        this.shieldSound.play().catch(e => console.log("Could not play collecting sound:", e));
    }
